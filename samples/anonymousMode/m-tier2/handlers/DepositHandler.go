...
import (
	...
	"github.com/hpe-usp-spire/signed-assertions/anonymousMode/m-tier2/models"
)
...
func DepositHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Gera chamada para MIDDLE TIER 3 workload 
	endpoint := "https://"+os.Getenv("MIDDLE_TIER3_IP")+"/deposit?DASVID="+assertion+"&deposit="+r.FormValue("deposit")
	log.Printf(endpoint)
