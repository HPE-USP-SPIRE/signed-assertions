...
import (
	...
	"github.com/hpe-usp-spire/signed-assertions/anonymousMode/m-tier3/models"
)
...
func DepositHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Gera chamada para MIDDLE TIER 4 workload 
	endpoint := "https://"+os.Getenv("MIDDLE_TIER4_IP")+"/deposit?DASVID="+assertion+"&deposit="+r.FormValue("deposit")
	log.Printf(endpoint)
