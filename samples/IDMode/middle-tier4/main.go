...
func main() {
	...
	log.Printf("Start serving Middle tier 4 API...")
...
func Get_balanceHandler(w http.ResponseWriter, r *http.Request) {
	...
	values := map[string]string{"DASVIDToken": fmt.Sprintf("%s",assertion), "IDArtifacts": fmt.Sprintf("%s",updSVID)}
...
func DepositHandler(w http.ResponseWriter, r *http.Request) {
	...
	endpoint := "https://"+os.Getenv("MIDDLE_TIER5_IP")+"/deposit?DASVID="+r.FormValue("DASVID")+"&deposit="+r.FormValue("deposit")
