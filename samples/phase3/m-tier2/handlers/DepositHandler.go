...
import (
	...
	"github.com/hpe-usp-spire/signed-assertions/phase3/m-tier2/local"
	...
	"github.com/hpe-usp-spire/signed-assertions/phase3/m-tier2/models"
	"github.com/hpe-usp-spire/signed-assertions/phase3/m-tier2/monitoring-prom"
)
...
func DepositHandler(w http.ResponseWriter, r *http.Request) {
	...
	endpoint := "https://"+os.Getenv("MIDDLE_TIER3_IP")+"/deposit?DASVID="+r.FormValue("DASVID")+"&deposit="+r.FormValue("deposit")
